...
public class Solution {
    public boolean checkBalanced(TreeNode root) {
        // Check if the tree is balanced starting from the root node
    ...
    private int checkHeight(TreeNode node) {
        ...
        // Check if the difference in heights of left and right subtrees is at most one
        if (Math.abs(leftHeight - rightHeight) > 1) {
            return -1;
        }
        
        // Height of the current node is the maximum of heights of left and right subtrees + 1
